...
from sCONST import *
from sQPlotGui import Ui_MainWindow
import sys
...
class sGPlot(QtGui.QMainWindow):
    ...
    def getTreeData(self,xField,yField,chID):
        if self.sqFrom == self.sqTo :
            cutString = ""
        else:
            cutString = chID+".seqTime > "+str(self.sqFrom)+ " && "+chID+".seqTime < "+str(self.sqTo+1)
        if self.tree:
            xField = chID+"."+xField
            yField = chID+"."+yField
    ...
    def setSQfrom(self,value):
        self.sqFrom = value
    def setSQto(self,value):
        self.sqTo = value
    ...
    def uiConfig(self):  
        ...
        self.ui.SQfromBox.valueChanged.connect(self.setSQfrom)
        self.ui.SQtoBox.valueChanged.connect(self.setSQto)
